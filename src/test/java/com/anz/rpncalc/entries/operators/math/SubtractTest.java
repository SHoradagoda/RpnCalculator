...
public class SubtractTest {
    ...
    private void testWith(double val1, double val2) {
        BigDecimal expected  = BigDecimal.valueOf(val2).subtract(BigDecimal.valueOf(val1));
        assertEquals(Value.valueOf(expected), new Subtract().operate(Value.valueOf(val1), Value.valueOf(val2)));
    }
